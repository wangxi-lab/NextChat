...
export const getServerSideConfig = () => {
  ...
  const isGoose = !!process.env.GOOSE_URL || !!process.env.GOOSE_API_KEY;
  ...
  return {
    ...
    isGoose,
    gooseUrl: process.env.GOOSE_URL,
    gooseApiKey: getApiKey(process.env.GOOSE_API_KEY),
